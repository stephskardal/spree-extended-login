...
desc 'Generate documentation for the extended_login extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ExtendedLoginExtension'
...
desc 'Test the extended_login extension.'
...
namespace :test do
  desc 'Functional test the extended_login extension.'
  ...
  desc 'Unit test the extended_login extension.'
